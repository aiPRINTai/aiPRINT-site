...
<head>
  ...
  <style>
    ...
    /* "How gifting works" thin rail under the hero. Single line on
       desktop (Pick · Personalize · Preview · Choose material · Ship),
       wraps to 2-3 rows on mobile. Subtle so it educates without
       competing with the tile grid. */
    .how-gifting-strip{display:flex;flex-wrap:wrap;justify-content:center;align-items:center;gap:.55rem 1rem;background:rgba(255,255,255,.03);border:1px solid rgba(255,255,255,.08);border-radius:999px;padding:.6rem 1.1rem;max-width:fit-content;margin:0 auto;}
    .how-step{display:inline-flex;align-items:center;gap:.5rem;white-space:nowrap;}
    .how-num{flex:none;display:inline-flex;align-items:center;justify-content:center;width:22px;height:22px;border-radius:999px;background:rgba(129,140,248,.14);color:#c7d2fe;font-weight:800;font-size:.78rem;border:1px solid rgba(129,140,248,.3);}
    .how-title{font-weight:600;font-size:.85rem;color:#e7eef8;line-height:1.2;}
    @media (min-width:768px){.how-title{font-size:.9rem;}}
...
<body>
  ...
  <header class="sticky top-0 z-50 bg-[#0b1020]/85 backdrop-blur border-b border-white/10">
    <div class="max-w-[1800px] mx-auto px-5 h-16 flex items-center justify-between">
      ...
      <!-- Nine nav items in one row was crashing at narrow-desktop widths
           (logo overlap, "How it works" wrapping mid-link). Bumped from
           md:flex (768px) to lg:flex (1024px) so cramped tablet widths
           fall back to the hamburger drawer, and added whitespace-nowrap
           so no link can break mid-label even when the row is tight. -->
      <nav class="hidden lg:flex items-center gap-5 text-sm xl:text-base whitespace-nowrap">
        <a href="/" class="hover:text-white">Home</a>
        <a href="/gifts.html" class="inline-flex items-center px-3 py-1 rounded-full bg-indigo-500/35 hover:bg-indigo-500/50 border border-indigo-400/50 text-white font-semibold">Gifts</a>
        <a href="/#how" class="hover:text-white">Process</a>
      ...
      <div class="flex items-center gap-2">
        ...
        <a href="/#create" class="btn-accent text-sm px-3.5 py-2 lg:hidden whitespace-nowrap">Create <span aria-hidden="true">→</span></a>
        <button id="navOpen" class="lg:hidden inline-flex items-center justify-center w-10 h-10 rounded-lg border border-white/15 text-white/90 hover:bg-white/10" aria-label="Open menu">
    ...
    <aside id="navDrawer" class="absolute right-0 top-0 h-full w-80 max-w-[88vw] bg-[#0b1020] border-l border-white/10 translate-x-full transition-transform duration-300">
      ...
      <nav class="px-4 py-4">
        <ul class="space-y-2 text-white/90 text-base">
          ...
          <li><a class="block rounded-lg px-3 py-2 bg-indigo-500/30 border border-indigo-400/40 text-white font-semibold" href="/gifts.html">Gifts</a></li>
          <li><a class="block rounded-lg px-3 py-2 hover:bg-white/10" href="/#how">Process</a></li>
  ...
  <section class="max-w-[1800px] mx-auto px-5 pt-12 pb-8 text-center">
    ...
    <p class="muted mt-5 max-w-2xl mx-auto text-lg leading-relaxed">
      ${TOTAL} starting points across ${CATEGORIES.length} categories. Each tile sets a prompt — make it yours.
    </p>
  ...
  <!-- HOW GIFTING WORKS — thin 5-step rail. Titles only so it reads in
       one scan and doesn't compete with the tile grid below. -->
  <section class="max-w-[1800px] mx-auto px-5 pb-6">
    <div class="how-gifting-strip">
      <div class="how-step"><span class="how-num">1</span><span class="how-title">Pick a gift idea</span></div>
      <div class="how-step"><span class="how-num">2</span><span class="how-title">Personalize</span></div>
      <div class="how-step"><span class="how-num">3</span><span class="how-title">Preview</span></div>
      <div class="how-step"><span class="how-num">4</span><span class="how-title">Choose material</span></div>
      <div class="how-step"><span class="how-num">5</span><span class="how-title">We review, print &amp; ship</span></div>
    </div>
  </section>
